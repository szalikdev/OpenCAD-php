			...
			<div class="col-md-3 left_col">
			   <div class="left_col scroll-view">
				  <div class="navbar nav_title" style="border: 0;">
					 <a href="javascript:void(0)" class="site_title"><i class="fas fa-broadcast-tower"></i> <span> Communications</span></a>
				  </div>
				  ...
				  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
					 <div class="menu_section">
						...
						<ul class="nav side-menu">
						   ...
						   <li>
							  <a><i class="fas fa-book"></i> Warnings <span class="fas fa-chevron-down"></span></a>
							  <ul class="nav child_menu">
						   ...
						   <li>
							  <a><i class="fas fa-book"></i> Citations <span class="fas fa-chevron-down"></span></a>
							  <ul class="nav child_menu">
			...
			<form role="form" action="<?php echo BASE_URL; ?>/actions/dispatchActions.php" method="post">
			  ...
			  <div class="form-group row">
                <label class="col-lg-2 control-label">Warrant Name</label>
                    ...
                    <optgroup label="Violent">
						<?php getDataSetTableWhere($dataSet = "warrant_types", $whereString = "warrant_violent", $isTrue = "1", $column1 = "warrant_type", $column2 = "warrant_description", $leadTrim = 17, $followTrim = 11); ?>
					</optgroup>
					<optgroup label="Non-violent">
						<?php getDataSetTableWhere($dataSet = "warrant_types", $whereString = "warrant_violent", $isTrue = "0", $column1 = "warrant_type", $column2 = "warrant_description", $leadTrim = 17, $followTrim = 11); ?>
					</optgroup>
				</select>
                  </div>
				<!-- ./ col-sm-9 -->
			  ...
			  <div class="form-group row">
				...
				<div class="col-lg-10">
				  ...
				  <?php getDataSetTable($dataSet = "departments", $column1 = "department_long_name", $column2 = "", $leadTrim = 17, $followTrim = 11, $isRegistration = false, $isVehicle = false); ?>
				  </select>
				</div>
				<!-- ./ col-sm-9 -->
			  </div>
